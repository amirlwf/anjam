...
آخرین نسخه‌ها در **[Releases](../../releases)** همین ریپو:

| پلتفرم | فایل |
|---|---|
| ویندوز (نصب‌کننده) | `Anjam-Setup-1.0.0.exe` |
| ویندوز (پورتبل، بدون نصب) | `Anjam-Portable-1.0.0.exe` |
| اندروید | `Anjam-1.0.0.apk` |
