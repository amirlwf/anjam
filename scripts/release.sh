#!/usr/bin/env bash
# Creates (or updates) the GitHub release v1.1.0 and uploads all artifacts.
...
try:
    ...
    d = []
names = {'Anjam-Setup-1.1.0.exe', 'Anjam-Portable-1.1.0.exe', 'Anjam-1.1.0.apk'}
...
up "Anjam-1.1.0.apk" "releases/Anjam-1.1.0.apk"
up "Anjam-Setup-1.1.0.exe" "release/Anjam-Setup-1.1.0.exe"
up "Anjam-Portable-1.1.0.exe" "release/Anjam-Portable-1.1.0.exe"
